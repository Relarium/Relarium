Relarium Core version 2.2.1 is now available from:

  <https://github.com/relarium-project/relarium/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/relarium-project/relarium/issues>

Compatibility
==============

Relarium Core is extensively tested on multiple operating systems using
...
Relarium Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Relarium was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/relarium-project-translations/).
