...
In order to support loading of multiple wallets in relarium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is relarium.cpp.
...
Changes to relarium.cpp
----------------------
relarium.cpp is the entry point into relarium-qt, and as such, will require some minor modifications to provide hooks for
