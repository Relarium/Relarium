Contributing to Relarium Core
============================

The Relarium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Relarium Core project, and is not to be
confused with overall Relarium Network Protocol consensus changes.

Whether a pull request is merged into Relarium Core rests with the project merge
...
Patches that change Relarium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Relarium consensus, it must have been
...
The project leader is the release manager for each Relarium Core release.
