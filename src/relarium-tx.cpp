...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Relarium Core relarium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  relarium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded relarium transaction") + "\n" +
                               "  relarium-tx [options] -create [commands]   " + _("Create hex-encoded relarium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded relarium transaction
