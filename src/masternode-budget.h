...
public:
    ...
    void NewBlock();
    CBudgetProposal* FindProposal(const std::string& sRLMroposalName);
    CBudgetProposal* FindProposal(uint256 nHash);
    CFinalizedBudget* FindFinalizedBudget(uint256 nHash);
    std::pair<std::string, std::string> GetVotes(std::string sRLMroposalName);
...
public:
    ...
    void AutoCheck();
    //total relarium paid out by this budget
...
public:
    ...
    */
    ...
    CBudgetProposal(std::string sRLMroposalNameIn, std::string strURLIn, int nBlockStartIn, int nBlockEndIn, CScript addressIn, CAmount nAmountIn, uint256 nFeeTXHashIn);
    ...
    std::string GetName() { return sRLMroposalName; }
    ...
    {
        //for syncing with other clients
        READWRITE(LIMITED_STRING(sRLMroposalName, 20));
...
public:
    ...
    CBudgetProposalBroadcast(std::string sRLMroposalNameIn, std::string strURLIn, int nPaymentCount, CScript addressIn, CAmount nAmountIn, int nBlockStartIn, uint256 nFeeTXHashIn);
    ...
    void swap(CBudgetProposalBroadcast& first, CBudgetProposalBroadcast& second) // nothrow
    {
        ...
        // by swapping the members of two classes,
        // the two classes are effectively swapped
        swap(first.sRLMroposalName, second.sRLMroposalName);
        swap(first.nBlockStart, second.nBlockStart);
