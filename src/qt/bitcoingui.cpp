                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Relarium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Relarium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and relarium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Relarium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Relarium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Relarium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Relarium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Relarium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Relarium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Relarium Core help message to get a list with possible Relarium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Relarium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Relarium network", "", count));
}
...
{
    QString strTitle = tr("Relarium Core"); // default title
