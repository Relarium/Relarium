...
/** Utility functions used by the Relarium Qt UI.
 */
namespace GUIUtil
{
...
// Render Relarium addresses in monospace font
...
// Parse "relarium:" URI into recipient object, return true on successful parsing
