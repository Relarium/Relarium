...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Relarium Core"),
     ...
     * override -datadir in the relarium.conf file in the default data directory
     * (to be consistent with relariumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
