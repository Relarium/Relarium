...
RESOURCES += src/qt/relarium.qrc src/qt/relarium_locale.qrc

TRANSLATIONS += src/qt/locale/relarium_bg.ts \
                src/qt/locale/relarium_de.ts \
                src/qt/locale/relarium_en.ts \
                src/qt/locale/relarium_es.ts \
                src/qt/locale/relarium_fi.ts \
                src/qt/locale/relarium_fr.ts \
                src/qt/locale/relarium_it.ts \
                src/qt/locale/relarium_ja.ts \
                src/qt/locale/relarium_pl.ts \
                src/qt/locale/relarium_pt.ts \
                src/qt/locale/relarium_ru.ts \
                src/qt/locale/relarium_sk.ts \
                src/qt/locale/relarium_sv.ts \
                src/qt/locale/relarium_vi.ts \
                src/qt/locale/relarium_zh_CN.ts \
                src/qt/locale/relarium_zh_TW.ts
