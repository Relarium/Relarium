...
This means one can have an always-on relariumd instance running, and another local relariumd/relarium-qt instance which connects to this node and receives blocks from it.
